...
# angular.z : 좌회전(+) / 우회전(-) 속도 rad/s
ACTION_MAP = {
    # ── 직선 이동 ──────────────────────────────────────────────
    "go straight":      {"linear": {"x":  0.5, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.0}},
    "go straight slow": {"linear": {"x":  0.2, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.0}},
    "go straight fast": {"linear": {"x":  0.8, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.0}},
    "move back":        {"linear": {"x": -0.5, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.0}},
    "move back slow":   {"linear": {"x": -0.2, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.0}},
    "stop":             {"linear": {"x":  0.0, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.0}},

    # ── 제자리 회전 (in-place spin) ────────────────────────────
    "rotate left":      {"linear": {"x":  0.0, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.6}},
    "rotate right":     {"linear": {"x":  0.0, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z": -0.6}},

    # ── 주행 중 완만한 회전 (arc turn) ─────────────────────────
    ...
    # ── 급회전 ─────────────────────────────────────────────────
    "sharp left":       {"linear": {"x":  0.2, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  1.0}},
    "sharp right":      {"linear": {"x":  0.2, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z": -1.0}},

    # ── 완만한 곡선 주행 ────────────────────────────────────────
    "curve left":       {"linear": {"x":  0.5, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z":  0.3}},
    "curve right":      {"linear": {"x":  0.5, "y": 0.0, "z": 0.0}, "angular": {"x": 0.0, "y": 0.0, "z": -0.3}},
}
